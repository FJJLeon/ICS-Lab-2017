...
# stored in register rB. I make iaddq a valid instruction who need
# regid and valC at Fetch stage, make d_srcB is D_rB, d_dstE is
# D_rB at Decode Stage, make aluA is E_valC, aluB is E_valB and 
# set_cc is true at Execute Stage when instruction is iaddq
####################################################################
#/* $begin pipe-all-hcl */
####################################################################
